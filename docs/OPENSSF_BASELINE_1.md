...
| OSPS-BR-01.01 | Met | Workflows do not pass untrusted issue/PR titles, branch names, or user-controlled metadata into shell commands. Workflow dispatch uses a typed choice input. | `.github/workflows/*.yml` | None. |
