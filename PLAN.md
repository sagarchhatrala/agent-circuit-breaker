# Agent Circuit Breaker v0.2 Alpha Plan

Project goal: build a deterministic safety layer between AI coding agents and the operating system.

The current release target is `v0.2.0-alpha.1`. This alpha adds command safety enforcement on top of the v0.1 filesystem safety foundation.
...
Remaining before tagging `v0.2.0-alpha.1`:
...
- `v0.2.0-alpha.1` tag is pushed to GitHub
- GitHub prerelease is published

## Next Milestones

After `v0.2.0-alpha.1`, continue with:
